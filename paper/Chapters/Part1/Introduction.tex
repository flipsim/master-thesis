...
describes both synchronous and asynchronous communication. Thus, showing that $\LFD$ serves an alternative
logical foundation for the $\pi$-calculus. The main contribution
of this thesis consists in mechanized proofs for type safety and the
Church-Rosser property for $\LFD$'s term assignment system, $\piFD$.
...
\begin{itemize}
  ...
  \item The last part delves into the metatheory of $\piFD$.
\end{itemize}