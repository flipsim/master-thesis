...
need not only structure their data, but also their communication. Milner's
...
(R-$\land$-Elim$_2$). Eliminating them finally creates a proof in normal form.
...
the resulting normal forms as an order pair $(b, a)$. This analogy fails in $\FD$
